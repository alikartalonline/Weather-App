...
function ArticleMaps() {
    ...
    const ScroollLeft = () => {
        ...
        // console.log("element right:",element.scrollLeft.toFixed()) // 612
    };
    ...
    const ScroollRight = () => {
        ...
        setScroller(element.scrollLeft.toFixed())
        // console.log("element right:",element.scrollLeft.toFixed()) // 0
    };
    ...
    //     let element = document.getElementById("mapScroller");
    //     setScroller(element.scrollLeft.toFixed())
    // }, [scroller, ScroollRight, ScroollLeft])


// const Scroller = document.getElementById("mapScroller")
// console.log("scrool element:", Scroolleft.toFixed())
    ...
    <div className='container'>
        <div className='row'>
            ...
            <div className=' mb-5 scroller' id="mapScroller">
                ...
                style={scroller === "612" ? {display:"none"} : null}
                onClick={() => ScroollLeft()}>
